...
class ApplicationCalibrage(tk.Tk):
    def __init__(self):
        ...
        # Layout principal
        self.sidebar = Interraction(self, self.app, width=350, bg=self.style_manager.BG_SIDEBAR)
        self.canvas_view = FenetreImage(self, self.app, bg=self.style_manager.BG_MAIN, bd=0, highlightthickness=0)

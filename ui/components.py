...
class Card(tk.Frame):
    ...
    def __init__(self, parent, title="", **kwargs):
        super().__init__(parent, bg="#FFFFFF", padx=20, pady=20, 
                         highlightbackground="#DCDFE3", highlightthickness=1, **kwargs)
        if title:
            lbl = tk.Label(self, text=title.upper(), font=("Segoe UI", 8, "bold"), 
                           bg="#FFFFFF", fg="#6C757D")
...
class image_frame(Card):
    ...
    def _build(self):
        ...
        f.pack(fill="x")
        tk.Label(f, text="Sélectionnez un fichier .jpg", font=("Segoe UI", 9), 
                 bg="#FFFFFF", fg="#495057").pack(side="left")
...
class Echelle_frame(Card):
    ...
    def _build(self):
        ...
        self.lbl = tk.Label(self.input_f, text="Longueur réelle (mm)", 
        ...
        self.btn = ttk.Button(self, text="Appliquer l'Échelle", 
                              command=self.apply_scale, style="Primary.TButton")
...
class Interraction(tk.Frame):
    ...
    def __init__(self, parent, app, **kwargs):
        ...
        self.app = app
        self.canvas = tk.Canvas(self, bg=kwargs.get('bg'), highlightthickness=0, width=width)
    ...
    def _setup_measurements(self):
        self.app.mesures_supp.mesures_supp_frame = tk.Frame(self.scrollable_frame, bg="#F0F2F5")
    ...
    def interraction_GUI(self):
        image_frame(self.scrollable_frame, self.app).pack(fill="x", padx=10, pady=(0, 15))
        Echelle_frame(self.scrollable_frame, self.app).pack(fill="x", padx=10, pady=(0, 15))
